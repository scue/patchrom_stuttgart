...
.field private static final RTC_ALARM_TIME_SETTING:Ljava/lang/String; = "com.android.server.alarm.rtc_alarm_time"

.field private static final RTC_MASK:I = 0x2

.field private static final RTC_POWERON_MASK:I = 0x10

.field private static final RTC_STARTUP_TIME_SETTING:Ljava/lang/String; = "com.android.server.alarm.rtc_startup_time"

.field private static final RTC_STARTUP_TYPE_PROPERTY:Ljava/lang/String; = "sys.rtc_startup_type"

.field private static final RTC_WAKEUP_MASK:I = 0x1

.field private static final SYSTEM_BOOT_TIME_MS:I = 0x0
...
.field private static final WINDOW_RTC_PREV:I = 0xea60

.field private static final YEAR_2010:Ljava/lang/String; = "2010-01-01 00:00:00"

.field private static final YEAR_2012:Ljava/lang/String; = "2012-01-01 00:00:00"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .prologue
    .line 156
    invoke-direct/range {p0 .. p0}, Landroid/app/IAlarmManager$Stub;-><init>()V
    ...
    iput-object v2, v0, Lcom/android/server/AlarmManagerService;->mLock:Ljava/lang/Object;
    ...
    iput-object v2, v0, Lcom/android/server/AlarmManagerService;->mRtcWakeupAlarms:Ljava/util/ArrayList;
    ...
    iput-object v2, v0, Lcom/android/server/AlarmManagerService;->mRtcAlarms:Ljava/util/ArrayList;
    ...
    iput-object v2, v0, Lcom/android/server/AlarmManagerService;->mElapsedRealtimeWakeupAlarms:Ljava/util/ArrayList;
    ...
    iput-object v2, v0, Lcom/android/server/AlarmManagerService;->mElapsedRealtimeAlarms:Ljava/util/ArrayList;
    ...
    iput-object v2, v0, Lcom/android/server/AlarmManagerService;->mIncreasingTimeOrder:Lcom/android/server/AlarmManagerService$IncreasingTimeOrder;
    ...
    iput-object v2, v0, Lcom/android/server/AlarmManagerService;->mRtcPoweronAlarms:Ljava/util/ArrayList;
    ...
    iput-object v2, v0, Lcom/android/server/AlarmManagerService;->mInexactDeliveryTimes:[J
    ...
    invoke-direct {v2, v0}, Lcom/android/server/AlarmManagerService$AlarmThread;-><init>(Lcom/android/server/AlarmManagerService;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/AlarmManagerService;->mWaitThread:Lcom/android/server/AlarmManagerService$AlarmThread;
    ...
    invoke-direct {v2, v0}, Lcom/android/server/AlarmManagerService$AlarmHandler;-><init>(Lcom/android/server/AlarmManagerService;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/AlarmManagerService;->mHandler:Lcom/android/server/AlarmManagerService$AlarmHandler;
    ...
    invoke-direct {v2, v0}, Lcom/android/server/AlarmManagerService$ResultReceiver;-><init>(Lcom/android/server/AlarmManagerService;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/AlarmManagerService;->mResultReceiver:Lcom/android/server/AlarmManagerService$ResultReceiver;
    ...
    iput-object v2, v0, Lcom/android/server/AlarmManagerService;->mBroadcastStats:Ljava/util/HashMap;

    .line 158
    const-string v2, "sys.rtc_startup_type"
    ...
    const-string v4, "get sys.rtc_startup_type="
    ...
    const-string v3, "com.android.server.alarm.rtc_startup_time"
    ...
    .line 163
    .local v23, startup_time:J
    invoke-virtual/range {p1 .. p1}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v2

    const-string v3, "com.android.server.alarm.rtc_alarm_time"
    ...
    const-string v4, "set sys.rtc_startup_type="
    ...
    .line 178
    .end local v9           #alarm_time:J
    .end local v16           #now:J
    .end local v23           #startup_time:J
    :cond_3
    move-object/from16 v0, p1

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/android/server/AlarmManagerService;->mContext:Landroid/content/Context;

    .line 179
    invoke-direct/range {p0 .. p0}, Lcom/android/server/AlarmManagerService;->init()I

    move-result v2

    move-object/from16 v0, p0

    iput v2, v0, Lcom/android/server/AlarmManagerService;->mDescriptor:I
    ...
    const-string v21, "2010-01-01 00:00:00"

    .line 189
    .local v21, refTime:Ljava/lang/String;
    const-string v11, "2012-01-01 00:00:00"

    .line 190
    .local v11, curYear:Ljava/lang/String;
    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v25

    .line 191
    .local v25, sysMillis:J
    ...
    .line 194
    .local v27, sysTime:Ljava/lang/String;
    :try_start_0
    move-object/from16 v0, v22
    ...
    .line 195
    .local v19, refMillis:J
    sub-long v12, v25, v19

    .line 196
    .local v12, difMillis:J
    const-string v2, "AlarmManager"
    ...
    const-string v4, "; reference time: "
    ...
    const-string v4, "system time is out of date, set it to: "
    ...
    invoke-virtual {v0, v2, v3}, Lcom/android/server/AlarmManagerService;->setTime(J)V
    :try_end_0
    .catch Ljava/text/ParseException; {:try_start_0 .. :try_end_0} :catch_0

    .line 208
    .end local v12           #difMillis:J
    .end local v19           #refMillis:J
    :cond_5
    :goto_0
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/AlarmManagerService;->setTimeZone(Ljava/lang/String;)V
    ...
    iput-object v2, v0, Lcom/android/server/AlarmManagerService;->mWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v2, v0, Lcom/android/server/AlarmManagerService;->mTimeTickSender:Landroid/app/PendingIntent;
    ...
    iput-object v2, v0, Lcom/android/server/AlarmManagerService;->mDateChangeSender:Landroid/app/PendingIntent;
    ...
    invoke-direct {v2, v0}, Lcom/android/server/AlarmManagerService$ClockReceiver;-><init>(Lcom/android/server/AlarmManagerService;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/AlarmManagerService;->mClockReceiver:Lcom/android/server/AlarmManagerService$ClockReceiver;

    .line 225
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/AlarmManagerService;->mClockReceiver:Lcom/android/server/AlarmManagerService$ClockReceiver;
    ...
    invoke-direct {v2, v0}, Lcom/android/server/AlarmManagerService$UninstallReceiver;-><init>(Lcom/android/server/AlarmManagerService;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/AlarmManagerService;->mUninstallReceiver:Lcom/android/server/AlarmManagerService$UninstallReceiver;
    ...
    iget-object v2, v0, Lcom/android/server/AlarmManagerService;->mWaitThread:Lcom/android/server/AlarmManagerService$AlarmThread;
    ...
    .end local v29           #tz:Ljava/lang/String;
    :catch_0
    move-exception v14
    ...
    const-string v3, "SimpleDateFormat.parse(), ParseException"
    ...
    .restart local v29       #tz:Ljava/lang/String;
    :cond_7
    const-string v2, "AlarmManager"
...
.method private removeLocked(Ljava/util/ArrayList;Landroid/app/PendingIntent;)V
    ...
    const-string v0, "persist.service.autostartenbale"
    ...
    const-string v0, "/data/system/alarm_rtc_time"
...
.method private setLocked(Lcom/android/server/AlarmManagerService$Alarm;)V
    ...
    const-string v18, "setLocked: alarm= "
    ...
    iget-object v2, v0, Lcom/android/server/AlarmManagerService;->mRtcPoweronAlarms:Ljava/util/ArrayList;
    ...
    .line 555
    .local v9, a:Lcom/android/server/AlarmManagerService$Alarm;
    ...
    .line 561
    .end local v9           #a:Lcom/android/server/AlarmManagerService$Alarm;
    :cond_1
    move-object/from16 v0, p0
    ...
    const-string v19, "com.android.server.alarm.rtc_alarm_time"
    ...
    const-string v2, "/data/system/alarm_rtc_time"
    ...
    .line 590
    .local v10, dout:Ljava/io/DataOutputStream;
    move-object/from16 v0, p1

    iget-wide v2, v0, Lcom/android/server/AlarmManagerService$Alarm;->when:J

    invoke-virtual {v10, v2, v3}, Ljava/io/DataOutputStream;->writeLong(J)V
    ...
    .line 596
    .end local v10           #dout:Ljava/io/DataOutputStream;
    ...
    const-string v18, "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ set alarm_rtc_time: "
    ...
    .line 553
    .restart local v9       #a:Lcom/android/server/AlarmManagerService$Alarm;
    .restart local v13       #i:I
    .restart local v16       #other:J
    :cond_6
    ...
    invoke-virtual {v2, v15, v0, v1}, Lcom/android/server/AlarmManagerService$AlarmHandler;->sendMessageAtTime(Landroid/os/Message;J)Z
...
.method private triggerAlarmsLocked(Ljava/util/ArrayList;Ljava/util/ArrayList;J)V
    ...
    .line 758
    :cond_7
    iget-object v3, p0, Lcom/android/server/AlarmManagerService;->mRtcPoweronAlarms:Ljava/util/ArrayList;
    ...
    const-string v4, "com.android.server.alarm.rtc_alarm_time"

    invoke-static {v3, v4, v9, v10}, Landroid/provider/Settings$System;->putLong(Landroid/content/ContentResolver;Ljava/lang/String;J)Z
    ...
    const-string v4, "com.android.server.alarm.rtc_startup_time"
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v1, v0, Lcom/android/server/AlarmManagerService;->mRtcPoweronAlarms:Ljava/util/ArrayList;
    ...
    .line 651
    const-string v1, "  Realtime poweron (now="
    ...
    iget-object v8, v0, Lcom/android/server/AlarmManagerService;->mRtcPoweronAlarms:Ljava/util/ArrayList;

    const-string v9, "  "

    const-string v10, "RTC_POWERON"
    ...
    invoke-static/range {v7 .. v12}, Lcom/android/server/AlarmManagerService;->dumpAlarmList(Ljava/io/PrintWriter;Ljava/util/ArrayList;Ljava/lang/String;Ljava/lang/String;J)V
    ...
    .line 665
    .local v13, be:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/String;Lcom/android/server/AlarmManagerService$BroadcastStats;>;"
    invoke-interface {v13}, Ljava/util/Map$Entry;->getValue()Ljava/lang/Object;

    move-result-object v14

    check-cast v14, Lcom/android/server/AlarmManagerService$BroadcastStats;
    ...
    iget-wide v1, v14, Lcom/android/server/AlarmManagerService$BroadcastStats;->aggregateTime:J
    ...
    .line 671
    iget-object v1, v14, Lcom/android/server/AlarmManagerService$BroadcastStats;->filterStats:Ljava/util/HashMap;
    ...
    .line 672
    .local v15, fe:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Landroid/content/Intent$FilterComparison;Lcom/android/server/AlarmManagerService$FilterStats;>;"
    const-string v1, "    "
    ...
    .line 677
    .end local v13           #be:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Ljava/lang/String;Lcom/android/server/AlarmManagerService$BroadcastStats;>;"
    .end local v14           #bs:Lcom/android/server/AlarmManagerService$BroadcastStats;
    .end local v15           #fe:Ljava/util/Map$Entry;,"Ljava/util/Map$Entry<Landroid/content/Intent$FilterComparison;Lcom/android/server/AlarmManagerService$FilterStats;>;"
