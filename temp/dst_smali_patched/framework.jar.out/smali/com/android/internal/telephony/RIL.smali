...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/internal/telephony/RIL;->is_USIM:Z
...
.method private getDataCallState(Landroid/os/Parcel;I)Lcom/android/internal/telephony/DataCallState;
    ...
    iget v5, v1, Lcom/android/internal/telephony/DataCallState;->cid:I
    ...
    const-string v5, "getDataCallState appending ifname="
...
.method private processSolicited(Landroid/os/Parcel;)V
    ...
    :sswitch_64
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/RIL;->responseSMSCString(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    :sswitch_67
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/RIL;->responseSmsStorage(Landroid/os/Parcel;)Ljava/lang/Object;
...
.method private processUnsolicited(Landroid/os/Parcel;)V
    ...
    .local v27, tr:Ljava/lang/Throwable;
    ...
    .end local v27           #tr:Ljava/lang/Throwable;
    :cond_0
    :goto_0
    return-void
    ...
    .local v13, newState:Lcom/android/internal/telephony/CommandsInterface$RadioState;
    invoke-virtual {v13}, Lcom/android/internal/telephony/CommandsInterface$RadioState;->toString()Ljava/lang/String;
    ...
    invoke-direct {v0, v13}, Lcom/android/internal/telephony/RIL;->switchToRadioState(Lcom/android/internal/telephony/CommandsInterface$RadioState;)V

    goto :goto_0

    .end local v13           #newState:Lcom/android/internal/telephony/CommandsInterface$RadioState;
    :pswitch_4
    :try_start_2
    invoke-direct/range {p0 .. p1}, Lcom/android/internal/telephony/RIL;->responseVoid(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    invoke-virtual/range {v23 .. v23}, Landroid/telephony/SmsMessage;->isDM()Z
    ...
    .local v4, DMpdu:Ljava/lang/String;
    new-instance v11, Landroid/content/Intent;

    const-string v28, "com.lenovo.dm.initialmessage"
    ...
    const-string v28, "initalmessage"
    ...
    .end local v4           #DMpdu:Ljava/lang/String;
    ...
    .local v6, autoSmsFlag:Ljava/lang/String;
    new-instance v28, Ljava/lang/StringBuilder;

    invoke-direct/range {v28 .. v28}, Ljava/lang/StringBuilder;-><init>()V

    const-string v29, " lianxla autoSmsFlag.equals(1):"
    ...
    const-string v29, "mobile_terselfreg_status"

    const-string v30, "gsm.info.imsi"
    ...
    const-string v29, "mobile_terselfreg_imei_status"

    const-string v30, "gsm.info.imei"
    ...
    const-string v28, "DM_SMS auto success"
    ...
    :cond_3
    const-string v28, "DM_SMS auto faile"
    ...
    .end local v6           #autoSmsFlag:Ljava/lang/String;
    .end local v22           #size:I
    ...
    invoke-static {v7}, Landroid/telephony/SmsCbMessage;->createFromPdu([B)Landroid/telephony/SmsCbMessage;

    move-result-object v24

    .local v24, smsCb:Landroid/telephony/SmsCbMessage;
    const-string v28, "RILJ"
    ...
    const-string v30, "Send Sms CB body = "

    invoke-virtual/range {v29 .. v30}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v29

    invoke-virtual/range {v24 .. v24}, Landroid/telephony/SmsCbMessage;->getMessageBody()Ljava/lang/String;
    ...
    .end local v7           #bytePdu:[B
    .end local v9           #i:I
    .end local v24           #smsCb:Landroid/telephony/SmsCbMessage;
    ...
    .local v12, listInfoRecs:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/cdma/CdmaInformationRecords;>;"
    ...
    .end local v12           #listInfoRecs:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/cdma/CdmaInformationRecords;>;"
...
.method static requestToString(I)Ljava/lang/String;
    ...
    :sswitch_65
    const-string v0, "RIL_REQUEST_SET_SMS_SAVE_POS"

    goto/16 :goto_0

    :sswitch_66
    const-string v0, "GET_SMS_STORAGE"
    ...
    :sswitch_6e
    const-string v0, "RIL_REQUEST_DIAL_VT"
...
.method private responseIccCardStatus(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v6}, Lcom/android/internal/telephony/IccCardApplication;->PinStateFromRILInt(I)Lcom/android/internal/telephony/IccCardStatus$PinState;

    move-result-object v6

    iput-object v6, v0, Lcom/android/internal/telephony/IccCardApplication;->pin1:Lcom/android/internal/telephony/IccCardStatus$PinState;
    ...
    iput-object v6, v0, Lcom/android/internal/telephony/IccCardApplication;->pin2:Lcom/android/internal/telephony/IccCardStatus$PinState;

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v6

    iput v6, v0, Lcom/android/internal/telephony/IccCardApplication;->pin1_num_retries:I

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v6

    iput v6, v0, Lcom/android/internal/telephony/IccCardApplication;->puk1_num_retries:I

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v6

    iput v6, v0, Lcom/android/internal/telephony/IccCardApplication;->pin2_num_retries:I

    invoke-virtual {p1}, Landroid/os/Parcel;->readInt()I

    move-result v6

    iput v6, v0, Lcom/android/internal/telephony/IccCardApplication;->puk2_num_retries:I

    invoke-virtual {v5, v0}, Lcom/android/internal/telephony/IccCardStatus;->addApplication(Lcom/android/internal/telephony/IccCardApplication;)V
    ...
    iget-object v6, v6, Lcom/android/internal/telephony/IccCardApplication;->app_type:Lcom/android/internal/telephony/IccCardApplication$AppType;
    ...
    const-string v7, "is usim : yes..."

    invoke-static {v6, v7}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    const/4 v6, 0x1

    sput-boolean v6, Lcom/android/internal/telephony/RIL;->is_USIM:Z
...
.method private responseRaw(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    .local v0, response:[B
    const-string v1, "gsm.info.dormant"
...
.method private responseSMSCString(Landroid/os/Parcel;)Ljava/lang/Object;
    .locals 2
    .parameter "p"
...
.method private responseSmsStorage(Landroid/os/Parcel;)Ljava/lang/Object;
    .locals 4
    .parameter "p"
...
.method public getSmsStorage(Landroid/os/Message;)V
    .locals 3
    .parameter "result"
...
.method public isUsimCard()Z
    ...
    .prologue
    sget-boolean v0, Lcom/android/internal/telephony/RIL;->is_USIM:Z
...
.method public rejectVT(ILandroid/os/Message;)V
    .locals 3
    .parameter "cause"
    .parameter "result"
...
.method public setSmsSavePos(ILandroid/os/Message;)V
    .locals 3
    .parameter "pos"
    .parameter "result"
