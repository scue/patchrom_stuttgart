...
.field private static final EVENT_PIN2PUK2_DONE:I = 0x10
...
.method public constructor <init>(Lcom/android/internal/telephony/PhoneBase;Ljava/lang/String;Ljava/lang/Boolean;)V
    ...
    const-string v0, "ro.ss.enable"

    invoke-static {v0, v3}, Landroid/os/SystemProperties;->getBoolean(Ljava/lang/String;Z)Z

    move-result v0

    iput-boolean v0, p0, Lcom/android/internal/telephony/IccCard;->mEnabling:Z
...
.method static synthetic access$100(Lcom/android/internal/telephony/IccCard;)Z
    .locals 1
    .parameter "x0"

    .prologue
    iget-boolean v0, p0, Lcom/android/internal/telephony/IccCard;->mEnabling:Z
...
.method private getIccCardStatusDone(Landroid/os/AsyncResult;)V
    ...
    .local v0, user:Landroid/os/Message;
    if-eqz v0, :cond_0

    iget-object v1, p0, Lcom/android/internal/telephony/IccCard;->mException:Ljava/lang/Throwable;
    ...
    const-string v3, "user is not null,  mPin1RetryCount = "
    ...
    iget-object v2, p0, Lcom/android/internal/telephony/IccCard;->mException:Ljava/lang/Throwable;
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/IccCard;->mException:Ljava/lang/Throwable;
...
.method public getIccCardState()Lcom/android/internal/telephony/IccCard$State;
    ...
    .local v0, app:Lcom/android/internal/telephony/IccCardApplication;
    iget v5, v0, Lcom/android/internal/telephony/IccCardApplication;->pin1_num_retries:I

    iput v5, p0, Lcom/android/internal/telephony/IccCard;->mPin1RetryCount:I

    iget v5, v0, Lcom/android/internal/telephony/IccCardApplication;->pin2_num_retries:I

    iput v5, p0, Lcom/android/internal/telephony/IccCard;->mPin2RetryCount:I

    iget v5, v0, Lcom/android/internal/telephony/IccCardApplication;->puk1_num_retries:I

    iput v5, p0, Lcom/android/internal/telephony/IccCard;->mPuk1RetryCount:I

    iget v5, v0, Lcom/android/internal/telephony/IccCardApplication;->puk2_num_retries:I

    iput v5, p0, Lcom/android/internal/telephony/IccCard;->mPuk2RetryCount:I
