...
.method public handleMessage(Landroid/os/Message;)V
    ...
    #getter for: Landroid/hardware/Camera;->mPreviewLightListener:Landroid/hardware/Camera$OnPreviewLightListener;
    invoke-static {v1}, Landroid/hardware/Camera;->access$1200(Landroid/hardware/Camera;)Landroid/hardware/Camera$OnPreviewLightListener;
    ...
    invoke-interface {v1, v2, v3}, Landroid/hardware/Camera$OnPreviewLightListener;->onPreviewLightChange(II)V
    ...
    #getter for: Landroid/hardware/Camera;->mContinousShotListener:Landroid/hardware/Camera$OnContinousShotListener;
    invoke-static {v1}, Landroid/hardware/Camera;->access$1300(Landroid/hardware/Camera;)Landroid/hardware/Camera$OnContinousShotListener;
    ...
    invoke-interface {v1, v2}, Landroid/hardware/Camera$OnContinousShotListener;->onOneShotBegin(I)V
    ...
    invoke-interface {v1, v2}, Landroid/hardware/Camera$OnContinousShotListener;->onOneShotEnd(I)V
    ...
    #getter for: Landroid/hardware/Camera;->mBlinkDetectionListener:Landroid/hardware/Camera$OnBlinkDetectionListener;
    invoke-static {v3}, Landroid/hardware/Camera;->access$1400(Landroid/hardware/Camera;)Landroid/hardware/Camera$OnBlinkDetectionListener;
    ...
    #getter for: Landroid/hardware/Camera;->mBlinkDetectionListener:Landroid/hardware/Camera$OnBlinkDetectionListener;
    invoke-static {v1}, Landroid/hardware/Camera;->access$1400(Landroid/hardware/Camera;)Landroid/hardware/Camera$OnBlinkDetectionListener;

    move-result-object v1

    iget v2, p1, Landroid/os/Message;->arg2:I

    invoke-interface {v1, v2}, Landroid/hardware/Camera$OnBlinkDetectionListener;->OnBlinkDetectionBegin(I)V
    ...
    :goto_4
    invoke-interface {v3, v2}, Landroid/hardware/Camera$OnBlinkDetectionListener;->OnBlinkDetectionEnd(Z)V
    ...
    #getter for: Landroid/hardware/Camera;->mPreviewFPSListener:Landroid/hardware/Camera$OnPreviewFPSListener;
    invoke-static {v1}, Landroid/hardware/Camera;->access$1500(Landroid/hardware/Camera;)Landroid/hardware/Camera$OnPreviewFPSListener;
    ...
    invoke-interface {v1, v2}, Landroid/hardware/Camera$OnPreviewFPSListener;->onPreviewFPSChange(I)V
    ...
    #getter for: Landroid/hardware/Camera;->mCheckLossFocusListener:Landroid/hardware/Camera$OnCheckLossFocusListener;
    invoke-static {v1}, Landroid/hardware/Camera;->access$1600(Landroid/hardware/Camera;)Landroid/hardware/Camera$OnCheckLossFocusListener;
    ...
    invoke-interface {v1, v2}, Landroid/hardware/Camera$OnCheckLossFocusListener;->onLossFocus(I)V
