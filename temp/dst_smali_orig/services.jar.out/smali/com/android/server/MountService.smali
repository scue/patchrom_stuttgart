...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/MountService$ExtraSdUMSHandler;,
...
.field private static final DEBUG_PORTING:Z = true
...
.field private static extra_sd_wait_retries:I


# instance fields
.field private UMSExceptionCanceled:Z
...
.field private mExternalStorageExtraSdPath:Ljava/lang/String;

.field private mExternalStoragePath:Ljava/lang/String;

.field private mExtraSdEjectAlone:Z

.field private final mExtraSdUMSHandler:Landroid/os/Handler;

.field private mExtraSdVolume:Landroid/os/storage/StorageVolume;

.field private final mHandler:Landroid/os/Handler;

.field private final mHandlerThread:Landroid/os/HandlerThread;

.field private mLegacyStateExtraSd:Ljava/lang/String;
...
.field private mUmsExceptionCancelMonitor:Z
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/server/MountService;->extra_sd_wait_retries:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v7, p0, Lcom/android/server/MountService;->UMSExceptionCanceled:Z

    const-string v3, "removed"

    iput-object v3, p0, Lcom/android/server/MountService;->mLegacyStateExtraSd:Ljava/lang/String;

    iput-boolean v7, p0, Lcom/android/server/MountService;->mUmsExceptionCancelMonitor:Z
    ...
    iput-boolean v7, p0, Lcom/android/server/MountService;->mExtraSdEjectAlone:Z
    ...
    iget-object v3, p0, Lcom/android/server/MountService;->mExtraSdVolume:Landroid/os/storage/StorageVolume;
    ...
    iput-object v3, p0, Lcom/android/server/MountService;->mExternalStorageExtraSdPath:Ljava/lang/String;
    ...
    const-string v5, "MountService constructor, mExternalStorageExtraSdPath: "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-object v5, p0, Lcom/android/server/MountService;->mExternalStorageExtraSdPath:Ljava/lang/String;
    ...
    const-string v4, "ACTION_USB_STATE add for mBroadcastReceiver"
    ...
    new-instance v3, Lcom/android/server/MountService$ExtraSdUMSHandler;
    ...
    invoke-direct {v3, p0, v4}, Lcom/android/server/MountService$ExtraSdUMSHandler;-><init>(Lcom/android/server/MountService;Landroid/os/Looper;)V

    iput-object v3, p0, Lcom/android/server/MountService;->mExtraSdUMSHandler:Landroid/os/Handler;
    ...
    const-string v4, "mExtraSdVolume == null "
...
.method static synthetic access$1002(Lcom/android/server/MountService;Z)Z
    ...
    .prologue
    iput-boolean p1, p0, Lcom/android/server/MountService;->UMSExceptionCanceled:Z
...
.method static synthetic access$2100(Lcom/android/server/MountService;Landroid/content/res/Resources;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$2400(Lcom/android/server/MountService;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method static synthetic access$2502(Lcom/android/server/MountService;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$300(Lcom/android/server/MountService;)Ljava/lang/String;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$500()I
    ...
    .prologue
    sget v0, Lcom/android/server/MountService;->extra_sd_wait_retries:I
...
.method static synthetic access$502(I)I
    ...
    .prologue
    sput p0, Lcom/android/server/MountService;->extra_sd_wait_retries:I
...
.method static synthetic access$508()I
    ...
    sput v1, Lcom/android/server/MountService;->extra_sd_wait_retries:I
...
.method static synthetic access$600(Lcom/android/server/MountService;)Ljava/lang/String;
    ...
    .prologue
    iget-object v0, p0, Lcom/android/server/MountService;->mExternalStorageExtraSdPath:Ljava/lang/String;
...
.method static synthetic access$700(Lcom/android/server/MountService;)Landroid/os/Handler;
    ...
    .prologue
    iget-object v0, p0, Lcom/android/server/MountService;->mExtraSdUMSHandler:Landroid/os/Handler;
...
.method private doMountVolume(Ljava/lang/String;)I
    ...
    const-string v6, "doMountVolume: Mounting "
...
.method private notifyShareAvailabilityChange(Z)V
    ...
    iget-boolean v5, p0, Lcom/android/server/MountService;->mUmsExceptionCancelMonitor:Z

    if-eqz v5, :cond_1

    iput-boolean v8, p0, Lcom/android/server/MountService;->UMSExceptionCanceled:Z

    const-string v5, "MountService"

    const-string v6, "UMSExceptionCanceled disconnect happened when UMS just start but remount be canceled"
...
.method private notifyVolumeStateChange(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    const-string v3, "updating volume state for media bad removal "

    invoke-static {v2, v3}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;)I

    const-string v0, "android.intent.action.MEDIA_SCAN_AFTER_UNMOUNT"
    ...
    const-string v4, "Updating media shared, path: "
    ...
    iget-object v2, p0, Lcom/android/server/MountService;->mExternalStoragePath:Ljava/lang/String;
    ...
    iput-boolean v2, p0, Lcom/android/server/MountService;->mUmsExceptionCancelMonitor:Z

    iget-boolean v2, p0, Lcom/android/server/MountService;->UMSExceptionCanceled:Z
    ...
    const-string v4, "sending H_UMS_EXCEPTION_CANCELED message, path: "
    ...
    iget-object v2, p0, Lcom/android/server/MountService;->mExtraSdUMSHandler:Landroid/os/Handler;

    iget-object v3, p0, Lcom/android/server/MountService;->mExtraSdUMSHandler:Landroid/os/Handler;
...
.method private readStorageList(Landroid/content/res/Resources;)V
    ...
    iget-object v4, v0, Lcom/android/server/MountService;->mExtraSdVolume:Landroid/os/storage/StorageVolume;

    if-nez v4, :cond_4

    move-object/from16 v0, p0

    iput-object v2, v0, Lcom/android/server/MountService;->mExtraSdVolume:Landroid/os/storage/StorageVolume;
...
.method private sendStorageIntent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-boolean v1, p0, Lcom/android/server/MountService;->mExtraSdEjectAlone:Z

    if-eqz v1, :cond_0

    const-string v1, "extrasd_eject_alone"

    iget-boolean v2, p0, Lcom/android/server/MountService;->mExtraSdEjectAlone:Z

    invoke-virtual {v0, v1, v2}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const/4 v1, 0x0

    iput-boolean v1, p0, Lcom/android/server/MountService;->mExtraSdEjectAlone:Z
...
.method private warnOnNotMounted()V
    ...
    const-string v1, "getSecureContainerList() called when Extra storage not mounted"
...
.method public isUsbMassStorageEnabled()Z
    ...
    invoke-direct {p0, v2, v3}, Lcom/android/server/MountService;->doGetVolumeShared(Ljava/lang/String;Ljava/lang/String;)Z
...
.method public setUsbMassStorageEnabled(Z)V
    ...
    const-string v7, "usb cable disconnected, will not mount or unmount"
    ...
    .local v0, extra_sd_existed:Z
    iget-object v6, p0, Lcom/android/server/MountService;->mExternalStorageExtraSdPath:Ljava/lang/String;

    invoke-virtual {p0, v6}, Lcom/android/server/MountService;->getVolumeState(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    .local v5, vsExtraSd:Ljava/lang/String;
    ...
    iput-boolean v9, p0, Lcom/android/server/MountService;->mUmsExceptionCancelMonitor:Z

    new-instance v3, Lcom/android/server/MountService$UmsEnableCallBack;

    iget-object v6, p0, Lcom/android/server/MountService;->mExternalStorageExtraSdPath:Ljava/lang/String;

    invoke-direct {v3, p0, v6, v1, v9}, Lcom/android/server/MountService$UmsEnableCallBack;-><init>(Lcom/android/server/MountService;Ljava/lang/String;Ljava/lang/String;Z)V

    .local v3, umscbExtraSd:Lcom/android/server/MountService$UmsEnableCallBack;
    ...
    .end local v3           #umscbExtraSd:Lcom/android/server/MountService$UmsEnableCallBack;
    :goto_1
    const-string v6, "mounted"
    ...
    iget-object v6, p0, Lcom/android/server/MountService;->mExtraSdUMSHandler:Landroid/os/Handler;

    iget-object v7, p0, Lcom/android/server/MountService;->mExtraSdUMSHandler:Landroid/os/Handler;
    ...
    const-string v8, "iNand status is :"
    ...
    invoke-direct {p0, v6, v1, p1}, Lcom/android/server/MountService;->doShareUnshareVolume(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    iget-object v8, p0, Lcom/android/server/MountService;->mExternalStorageExtraSdPath:Ljava/lang/String;
    ...
    const-string v8, "Extra SD is not inserted: "
    ...
    invoke-direct {v2, p0, v6, v1, v9}, Lcom/android/server/MountService$UmsEnableCallBack;-><init>(Lcom/android/server/MountService;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    const-string v8, "ERROR!!! iNand is not mounted pls check the status: "
...
.method public shutdown(Landroid/os/storage/IMountShutdownObserver;)V
    ...
    const-string v11, "Shutting down, about to unmount volume. path: "
...
.method public unmountVolume(Ljava/lang/String;ZZ)V
    ...
    const-string v3, "liuxu, *************** unmountVolume() *****************"
    ...
    iput-boolean v5, p0, Lcom/android/server/MountService;->mExtraSdEjectAlone:Z
