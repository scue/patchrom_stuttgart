...
.field private mLastSuplServerHost:Ljava/lang/String;

.field private mLastSuplServerPort:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/location/ILocationManager;)V
    ...
    iput-boolean v9, p0, Lcom/android/server/location/GpsLocationProvider;->mIsUsbConnected:Z
...
.method static synthetic access$500(Lcom/android/server/location/GpsLocationProvider;)Z
    ...
    .prologue
    iget-boolean v0, p0, Lcom/android/server/location/GpsLocationProvider;->mIsUsbConnected:Z
...
.method static synthetic access$502(Lcom/android/server/location/GpsLocationProvider;Z)Z
    ...
    .prologue
    iput-boolean p1, p0, Lcom/android/server/location/GpsLocationProvider;->mIsUsbConnected:Z
...
.method private startNavigating(Z)V
    ...
    .local v18, propSimState:Ljava/lang/String;
    ...
    const-string v4, "startNavigating dataEnabled="
    ...
    const-string v4, ", mIsUsbConnected="
    ...
    iget-boolean v4, v0, Lcom/android/server/location/GpsLocationProvider;->mIsUsbConnected:Z

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v3

    const-string v4, ", propSimState="
    ...
    iget-boolean v2, v0, Lcom/android/server/location/GpsLocationProvider;->mIsUsbConnected:Z

    if-eqz v2, :cond_1

    const-string v2, "GpsLocationProvider"

    const-string v3, "startNavigating Pls open data connection."

    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    new-instance v17, Lcom/android/server/location/GpsLocationProvider$3;
    ...
    invoke-virtual {v13, v2}, Landroid/app/AlertDialog;->setCancelable(Z)V
    ...
    const-string v3, "agps_server_infos"

    invoke-static {v2, v3}, Landroid/provider/Settings$Secure;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v22

    .local v22, strServerInfos:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    const-string v3, "agps_cur_server_name"
    ...
    .local v20, strCurServerName:Ljava/lang/String;
    const-string v2, "GpsLocationProvider"
    ...
    const-string v4, "startNavigating strCurServerName="
    ...
    const-string v4, ",strServerInfos="
    ...
    .local v11, arrServers:[Ljava/lang/String;
    move-object v9, v11
    ...
    .local v21, strServer:Ljava/lang/String;
    ...
    .local v10, arrInfos:[Ljava/lang/String;
    array-length v2, v10
    ...
    iget-object v3, v0, Lcom/android/server/location/GpsLocationProvider;->mLastSuplServerHost:Ljava/lang/String;
    ...
    iget v3, v0, Lcom/android/server/location/GpsLocationProvider;->mLastSuplServerPort:I
    ...
    iput-object v2, v0, Lcom/android/server/location/GpsLocationProvider;->mLastSuplServerHost:Ljava/lang/String;
    ...
    iput v2, v0, Lcom/android/server/location/GpsLocationProvider;->mLastSuplServerPort:I
    ...
    const-string v4, ",mSuplServerPort="
    ...
    .end local v10           #arrInfos:[Ljava/lang/String;
    :cond_4
    add-int/lit8 v14, v14, 0x1
    ...
    .end local v11           #arrServers:[Ljava/lang/String;
    .end local v12           #dataEnabled:Z
    .end local v14           #i$:I
    .end local v15           #isSimReady:Z
    .end local v16           #len$:I
    .end local v18           #propSimState:Ljava/lang/String;
    .end local v20           #strCurServerName:Ljava/lang/String;
    .end local v21           #strServer:Ljava/lang/String;
    .end local v22           #strServerInfos:Ljava/lang/String;
    :cond_5
    const/4 v12, 0x0

    goto/16 :goto_0

    .restart local v12       #dataEnabled:Z
    :cond_6
    const/4 v8, 0x0
    ...
    .restart local v15       #isSimReady:Z
    .restart local v18       #propSimState:Ljava/lang/String;
    :cond_7
    const/4 v2, 0x2
    ...
    iget v4, v0, Lcom/android/server/location/GpsLocationProvider;->mPositionMode:I
