...
.method private static addOrUpdateNetworkNative(Landroid/net/wifi/WifiConfiguration;)Landroid/net/wifi/NetworkUpdateResult;
    ...
    const-string v24, "CMD_SAVE_NETWORK existed network, config.priority="
    ...
    invoke-static/range {v23 .. v24}, Landroid/net/wifi/WifiNative;->getNetworkVariableCommand(ILjava/lang/String;)Ljava/lang/String;

    move-result-object v19

    .line 893
    .local v19, strPriority:Ljava/lang/String;
    ...
    const-string v24, "CMD_SAVE_NETWORK config.priority="
    ...
    .line 904
    .end local v19           #strPriority:Ljava/lang/String;
    :cond_2
    const/16 v20, 0x1
    ...
    .end local v17           #sConfig:Landroid/net/wifi/WifiConfiguration;
    .end local v20           #updateFailed:Z
    .restart local v19       #strPriority:Ljava/lang/String;
    :catch_0
    move-exception v23
