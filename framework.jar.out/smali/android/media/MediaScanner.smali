...
.method private postscan([Ljava/lang/String;)V
    ...
    .line 1157
    .end local v7           #mgr:Landroid/os/storage/StorageManager;
    .end local v9           #storagePaths:[Ljava/lang/String;
    :cond_1
    :goto_1
    if-eqz v3, :cond_0
    ...
    invoke-interface {v13, v14, v11, v15, v0}, Landroid/content/IContentProvider;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .restart local v7       #mgr:Landroid/os/storage/StorageManager;
    .restart local v9       #storagePaths:[Ljava/lang/String;
    :cond_2
    const/4 v13, 0x1

    aget-object v13, v9, v13

    invoke-virtual {v7, v13}, Landroid/os/storage/StorageManager;->getVolumeState(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v12

    .line 1128
    .local v12, volumeState:Ljava/lang/String;
    const-string/jumbo v13, "removed"
    ...
    .end local v7           #mgr:Landroid/os/storage/StorageManager;
    .end local v9           #storagePaths:[Ljava/lang/String;
    .end local v12           #volumeState:Ljava/lang/String;
    :cond_3
...
.method public scanSingleFile(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    iget-wide v7, v14, Landroid/media/MediaScanner$FileCacheEntry;->mRowId:J
    ...
    invoke-interface {v2, v3, v4, v7}, Landroid/content/IContentProvider;->delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    .line 1283
    .restart local v12       #bFileExist:Z
