...
.method public constructor <init>(Landroid/content/Context;Landroid/webkit/WebViewCore;Landroid/webkit/CallbackProxy;Landroid/webkit/WebSettings;Ljava/util/Map;)V
    ...
    .line 99
    iput-wide v3, p0, Landroid/webkit/BrowserFrame;->mHistoryBytesReceived:J

    .line 100
    iput-wide v3, p0, Landroid/webkit/BrowserFrame;->mCurrentFrameBytesReceived:J
...
.method private GetTotalBytesReceived()J
    .locals 4

    .prologue
    .line 1343
    iget-wide v0, p0, Landroid/webkit/BrowserFrame;->mHistoryBytesReceived:J

    iget-wide v2, p0, Landroid/webkit/BrowserFrame;->mCurrentFrameBytesReceived:J
...
.method private postIsRSSNotification(Ljava/lang/String;)V
    .locals 3
    .parameter "url"
    ...
    const-string/jumbo v2, "postIsRSSNotification : "
    ...
    invoke-virtual {v0, p1}, Landroid/webkit/CallbackProxy;->onIsRSSNotification(Ljava/lang/String;)V

    .line 1355
    return-void
.end method

.method private reportCookieAccessDenied()V
    .locals 1
    ...
    invoke-virtual {v0}, Landroid/webkit/CallbackProxy;->onReceivedCookieAccessDenied()V
...
.method private setProgressTotalBytesReceived(J)V
    .locals 3
    .parameter "size"
    ...
    iput-wide v0, p0, Landroid/webkit/BrowserFrame;->mHistoryBytesReceived:J

    .line 1334
    iget-object v0, p0, Landroid/webkit/BrowserFrame;->mCallbackProxy:Landroid/webkit/CallbackProxy;

    invoke-direct {p0}, Landroid/webkit/BrowserFrame;->GetTotalBytesReceived()J

    move-result-wide v1

    invoke-virtual {v0, v1, v2}, Landroid/webkit/CallbackProxy;->onUpdateBytesReceived(J)V
