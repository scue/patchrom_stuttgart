...
.method private createAllApnList()V
    ...
    const-string v1, "Get PreferredAPN  return null, so set preferAPN "
    ...
    const-string v1, "Get PreferredAPN allApns no null "
    ...
    iget-object v7, v6, Lcom/android/internal/telephony/ApnSetting;->types:[Ljava/lang/String;
    ...
    const-string v1, "No preferredApn, set to 1st of allApns : "
...
.method private getPreferredApn()Lcom/android/internal/telephony/ApnSetting;
    ...
    .line 2522
    const-string v0, "getPreferredApn: cursor no null"
    ...
    const-string v1, "getPreferredApn: getCount="
...
.method private onDataStateChanged(Landroid/os/AsyncResult;)V
    ...
    const-string v23, "begin onDataStateChanged: Data Activity updated to NONE. isAnyDataCallActive = "
    ...
    .line 1337
    const-string v22, "gsm.info.dormant"
...
.method private trySetupData(Lcom/android/internal/telephony/ApnContext;)Z
    ...
    invoke-virtual {p0, v3}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->getAnyDataEnabled(Ljava/lang/String;)Z
...
.method private updateDataActivity()V
    ...
    const-string/jumbo v2, "updateDataActivity: for fast dormancy, newActivity="
    ...
    const-string v2, "gsm.info.dormant"
...
.method public getAnyDataEnabled(Ljava/lang/String;)Z
    ...
    iget-boolean v3, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mAlwaysEnableMms:Z
    ...
    invoke-direct {p0, v3}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->isDataAllowed(Lcom/android/internal/telephony/ApnContext;)Z
    ...
    .line 587
    const-string v3, "getAnyDataEnabled, always enable mms."
    ...
    const-string v4, " - mInternalDataEnabled = flase"
    ...
    const-string v4, "getAnyDataEnabled: data not allowed due to"
...
.method protected onDataSetupComplete(Landroid/os/AsyncResult;)V
    ...
    .line 2014
    const-string/jumbo v20, "onDataSetupComplete: no connection to DC, handle as error"
    ...
    .line 2015
    sget-object v8, Lcom/android/internal/telephony/DataConnection$FailCause;->CONNECTION_TO_DATACONNECTIONAC_BROKEN:Lcom/android/internal/telephony/DataConnection$FailCause;
    ...
    .line 2102
    const-string/jumbo v20, "onDataSetupComplete: All APN\'s had permanent failures, stop retrying"
    ...
    .line 2104
    sget-object v20, Lcom/android/internal/telephony/DataConnectionTracker$State;->FAILED:Lcom/android/internal/telephony/DataConnectionTracker$State;
    ...
    const-string/jumbo v21, "onDataSetupComplete: No apnContext"
    ...
    const-string/jumbo v21, "onDataSetupComplete: success apn="
    ...
    .line 2032
    const-string/jumbo v20, "onDataSetupComplete: no apn setting, handle as error"
    ...
    .line 2053
    const-string/jumbo v20, "onDataSetupComplete: PREFERED APN is null"
    ...
    const-string/jumbo v21, "onDataSetupComplete: NumberFormatException making ProxyProperties ("
    ...
    check-cast v20, Lcom/android/internal/telephony/DataConnection$FailCause;
    ...
    :goto_3
    const-string/jumbo v20, "onDataSetupComplete: error apn=%s cause=%s"
    ...
    .line 2089
    const-string/jumbo v20, "onDataSetupComplete: WaitingApns.size=%d WaitingApnsPermFailureCountDown=%d"
    ...
    :cond_b
    const-string/jumbo v20, "onDataSetupComplete: Not all permanent failures, retry"
    ...
    check-cast v20, Lcom/android/internal/telephony/DataConnection$CallSetupException;

    invoke-virtual/range {v20 .. v20}, Lcom/android/internal/telephony/DataConnection$CallSetupException;->getRetryOverride()I
    ...
    .line 2118
    const-string v20, "No retry is suggested."
    ...
    .line 2127
    .local v19, waitingApnItr:Ljava/util/Iterator;,"Ljava/util/Iterator<Lcom/android/internal/telephony/ApnSetting;>;"
    :goto_4
    ...
    const-string/jumbo v21, "waitingApn["
    ...
    .line 2130
    :cond_f
    const-string/jumbo v20, "onDataSetupComplete: Try next APN"
    ...
    .line 2132
    sget-object v20, Lcom/android/internal/telephony/DataConnectionTracker$State;->SCANNING:Lcom/android/internal/telephony/DataConnectionTracker$State;
    ...
    .line 2135
    sget v20, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->APN_DELAY_MILLIS:I
...
.method protected onDisconnectDone(ILandroid/os/AsyncResult;)V
    ...
    const-string/jumbo v7, "onDisconnectDone: EVENT_DISCONNECT_DONE connId="
    ...
    .line 2151
    :cond_0
    const-string v6, "Invalid ar in onDisconnectDone"
    ...
    invoke-direct {p0, v6}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->retryAfterDisconnected(Ljava/lang/String;)Z
    ...
    .line 2178
    const-string v6, "get preferred apn because preferred apn has changed."
    ...
    .line 2180
    .local v1, apnSetting:Lcom/android/internal/telephony/ApnSetting;
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/ApnContext;->setApnSetting(Lcom/android/internal/telephony/ApnSetting;)V

    .line 2184
    .end local v1           #apnSetting:Lcom/android/internal/telephony/ApnSetting;
    :cond_2
    iget-boolean v6, p0, Lcom/android/internal/telephony/DataConnectionTracker;->mIsScreenOn:Z

    if-nez v6, :cond_4

    .line 2186
    const-string v6, "Deactived by network"
    ...
    const-string/jumbo v7, "time hour is"
    ...
    invoke-direct {p0, v6, v0}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->startAlarmForReconnect(ILcom/android/internal/telephony/ApnContext;)V
    ...
    :cond_4
    const-string/jumbo v6, "startAlarmForReconnect after disconnect done"

    invoke-virtual {p0, v6}, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->log(Ljava/lang/String;)V

    .line 2201
    sget v6, Lcom/android/internal/telephony/gsm/GsmDataConnectionTracker;->APN_DELAY_MILLIS:I
